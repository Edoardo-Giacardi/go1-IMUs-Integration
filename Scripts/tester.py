...
class Bus2Pub_Imu3(Node):
    def __init__(self):
        super().__init__('bus2_imu3_pub')

        # Initialize the I2C bus
        self.i2c_bus = I2C(4) # /dev/i2c-4 for sensors 3 
    ...
    def publish_imu(self):
        ...
        self.pub_imu3_bus2.publish(imu_msg)
