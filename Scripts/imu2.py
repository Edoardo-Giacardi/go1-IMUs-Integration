...
class Bus1Pub_Imu2(Node):
    def __init__(self):
        super().__init__('bus1_imu2_pub')

        # Initialize the I2C bus
        self.i2c_bus = I2C(1) # /dev/i2c-1 for sensor 2 
    ...
    def publish_imu(self):
        ...
        try:
            ...
            self.get_logger().warn(f"Error reading sensor on bus#1: {e}")

        self.pub_imu2_bus1.publish(imu_msg)
