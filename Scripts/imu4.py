...
class Bus3Pub_Imu4(Node):
    def __init__(self):
        super().__init__('bus3_imu4_pub')

        # Initialize the I2C bus
        self.i2c_bus = I2C(3) # /dev/i2c-3 for sensor 4
    ...
    def publish_imu(self):
        ...
        try:
            ...
            self.get_logger().warn(f"Error reading sensor on bus#3: {e}")

        self.pub_imu4_bus3.publish(imu_msg)
